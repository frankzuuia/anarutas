...
3. Calendario operativo, importación idempotente de pedidos confirmados, carga individual, selección de unidades.
...
- Periodo de captura de pedidos: fecha de creación/confirmación/entrega, corte, días laborables/feriados.
